...
<script>
    import iconDot from '../../node_modules/@uswds/uswds/dist/img/icon-dot-gov.svg';
    ...
    export default {
        ...
        mounted() {
          ...
          // const bannerElement = document.querySelector('#gov-banner-default');
          // bannerElement.setAttribute('hidden', '""');
        }
    }
</script>
<style scoped lang="scss">
  $background: #323333; //match USGS header
